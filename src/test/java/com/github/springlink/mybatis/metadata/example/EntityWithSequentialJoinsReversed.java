...
@SqlEntity
public class EntityWithSequentialJoinsReversed {
	@SqlJoin(EntityWithSequentialJoinsReversed.class)
	private static final SqlCriterion join2 = SqlCriterion.eq("join2.name", SqlReference.of("name"));
